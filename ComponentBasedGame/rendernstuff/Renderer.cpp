...
{
	myBuffers[myActiveBuffer ^ 1].Add(aRenderCommand);
}

void Renderer::RenderCircle(const CU::Vector2<float> aCenterPoint, const float aRadius, const int aNumPointsOnCircle)
{
