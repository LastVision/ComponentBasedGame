...
public:
	...
	inline void SetColor(DWORD aColor = hgeColor(1.f, 1.f, 1.f, 1.f).GetHWColor());
...
{
	myRenderCommand.SetColor(hgeColor(aColor));
}
...
void Sprite::SetRenderPriority(const int aPriority)
{
	myRenderCommand.SetRenderPriority(aPriority);
}